...
import 'package:recipeapp/entities/complete_recipe.dart';
import 'package:recipeapp/widgets/recipe_instructions.dart';
...
class RecipeDetailsPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isBookmarked =
        ref.read(bookmarksProvider.notifier).isBookmarked(recipe.id);
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          launchUrl(Uri.parse(recipe.youtubeUrl))
              .then((value) {})
              .catchError((e) {});
        },
