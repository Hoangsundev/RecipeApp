...
import 'package:recipeapp/providers/search_recipes_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: SearchAnchor.bar(
        ...
        barHintText: "Tìm kiếm bất kỳ công thức nào",
        barBackgroundColor:
            WidgetStatePropertyAll(theme.colorScheme.surfaceContainerLowest),
        ...
        suggestionsBuilder: (context, controller) async {
          ...
          // Kiểm tra nếu recipes là null hoặc không phải Iterable
          if (recipes == null || recipes is! Iterable) {
            return [
              const Padding(
          ...
          return List.generate(recipes.length, (index) {
            ...
            return Padding(
              padding:
                  const EdgeInsets.all(16).copyWith(top: index == 0 ? 8 : 0),
              child: ListTile(
